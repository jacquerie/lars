...
\author{
  \IEEEauthorblockN{
    Marios Kogias\IEEEauthorrefmark{1},
    Daniel Lovasko\IEEEauthorrefmark{2},
    Jacopo Notarstefano\IEEEauthorrefmark{3},
    Laura Rueda\IEEEauthorrefmark{3} and
    Jan Stypka\IEEEauthorrefmark{3}
  }
  \IEEEauthorblockA{
    \IEEEauthorrefmark{1}
    marios.kogias@epfl.ch (EPFL)
  }
  \IEEEauthorblockA{
    \IEEEauthorrefmark{2}
